...
/// <summary>
/// Options for MPass SAML authentication.
/// </summary>
public class MPassSamlOptions : RemoteAuthenticationOptions
{
    /// <summary>
    /// Constructs a default instance of <see cref="MPassSamlOptions"/>.
    /// </summary>
    ...
    /// </summary>
    public TimeSpan SamlMessageTimeout { get; set; } = MPassSamlDefaults.SamlMessageTimeout;
